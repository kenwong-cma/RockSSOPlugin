...
{
    /// <summary>
    /// Authenticates a user using CMD (Entra)
    /// </summary>
    /// <seealso cref="Rock.Security.AuthenticationComponent" />
    [Description("CMD Entra Authentication Provider")]
    [Export(typeof(AuthenticationComponent))]
    [ExportMetadata("ComponentName", "CMD Entra")]
    ...
    [Rock.SystemGuid.EntityTypeGuid("C2430829-4275-4157-B765-6FBB80F480A1")]
    public class CMDEntra : AuthenticationComponent, IExternalRedirectAuthentication
    {
        /// <summary>

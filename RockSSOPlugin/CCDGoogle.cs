...
namespace Rock.Security.ExternalAuthentication
{
    ...
    [Description("CCD Google Authentication Provider")]
    [Export(typeof(AuthenticationComponent))]
    [ExportMetadata("ComponentName", "CCD Google")]

    [TextField("Client ID", "The Google Client ID")]
    [TextField("Client Secret", "The Google Client Secret")]

    [Rock.SystemGuid.EntityTypeGuid("B4835995-4CF4-47C3-821E-B59403407E7D")]
    public class CCDGoogle : AuthenticationComponent, IExternalRedirectAuthentication
    {
        /// <summary>

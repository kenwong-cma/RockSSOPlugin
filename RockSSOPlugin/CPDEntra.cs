...
{
    /// <summary>
    /// Authenticates a user using CPD (Entra)
    /// </summary>
    /// <seealso cref="Rock.Security.AuthenticationComponent" />
    [Description("CPD Entra Authentication Provider")]
    [Export(typeof(AuthenticationComponent))]
    [ExportMetadata("ComponentName", "CPD Entra")]
    ...
    [Rock.SystemGuid.EntityTypeGuid("25298988-BE72-4C23-B369-BAB5BF3E3D1E")]
    public class CPDEntra : AuthenticationComponent, IExternalRedirectAuthentication
    {
        /// <summary>

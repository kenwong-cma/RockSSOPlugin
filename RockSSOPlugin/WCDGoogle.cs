...
namespace Rock.Security.ExternalAuthentication
{
    ...
    [Description("WCD Google Authentication Provider")]
    [Export(typeof(AuthenticationComponent))]
    [ExportMetadata("ComponentName", "WCD Google")]

    [TextField("Client ID", "The Google Client ID")]
    [TextField("Client Secret", "The Google Client Secret")]

    [Rock.SystemGuid.EntityTypeGuid("6693991C-1C5C-4955-A761-4E701CFE572B")]
    public class WCDGoogle : AuthenticationComponent, IExternalRedirectAuthentication
    {
        /// <summary>
